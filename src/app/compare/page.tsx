            ...
            <section className="py-8">
                <div className="container mx-auto px-4">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
                        ...
                        {/* Card 3 */}
                        <div className="flex flex-col rounded-[2.5rem] bg-[#faf5ff] overflow-hidden shadow-sm transition-all hover:shadow-xl group">
                            <div className="relative h-64 w-full overflow-hidden">
                                <Image
                                    src="/hero-3.png"
                                    alt="Lyme Protection"
                            ...
                            <div className="p-8 md:p-10 bg-white flex-grow flex items-center justify-center text-center">
                                <p className="text-xl md:text-2xl font-bold text-gray-900 leading-snug">
                                    The First Combo Preventative To Block Lyme Infections
                                </p>
                            </div>
                        </div>
                        {/* Card 4 */}
